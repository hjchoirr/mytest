...
public class GameController extends AbstractController {
    ...
    private void change(int menuNo) {
        ...
        switch(menuNo) {
            case 1: controller = locator.find(GameMenu.ALONE); break;
            case 2: controller = locator.find(GameMenu.TOGETHER); break;
            case 3: controller = locator.find(GameMenu.RANKING); break;
            default:
